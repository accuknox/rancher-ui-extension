<template>
    <div class="modal-overlay">
      <div class="modal-content">
        ...
        <input v-model="form.authToken" class="input" placeholder="Enter KSPM Auth Token" />
  
        <label class="mt-4">Tenant ID</label>
        <input v-model="form.tenant" class="input" placeholder="Enter Tenant ID" />
  
        <label class="mt-4">Label</label>
        <input v-model="form.label" class="input" placeholder="Enter Label" />
        ...
        <div class="mt-6">
          ...
          <button class="btn ml-2" @click="onCancel">Cancel</button>
        </div>
      </div>
    </div>
  </template>
